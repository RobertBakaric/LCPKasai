...
cout <<"***************************************************************************************"<<"\n";
cout <<"                  LCPKasai - logest common prefix array computation tool               "<<"\n";
cout <<"                                          by                                           "<<"\n";
cout <<"                                    Robert Bakaric                                     "<<"\n\n";
cout <<"CONTACT:                                                                               "<<"\n";
...
cout <<"         3. Kasai et al. Linear-Time Longest-Common-Prefix Computation in              "<<"\n";
cout <<"            Suffix Arrays and Its Applications. 2001.                                  "<<"\n\n";
cout <<"LICENSE:                                                                               "<<"\n";
...
/* Construct Sufix array */
   try{
      ...
      LCPArrayKasai<int> LCP(SA.GetSuffixArray(), text);
      
      cout << "Suffix Array:\n" << SA.GetSuffixArray() << "\nLCP Array:\n" << LCP.GetLCPArray() <<  endl;
